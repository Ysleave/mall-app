  ...
  >
    ...
    <a-form-model-item label="商品类目" prop="category">
      <a-select v-model="form.category">
        <a-select-option value="1" name="type" v-for="list in categoryList" :key="list.id" :value="list.id">
           {{list.name}}
        </a-select-option>
      </a-select>
      <a-select v-model="form.c_items">
        <a-select-option v-for="list in categoryList" :key="list.id" :value="list.id" value="1" name="type">
          Online
        </a-select-option>
      </a-select>
    </a-form-model-item>
